...
//        int session_id = SessionManager.getOngoingSessionId();
        ...
        SensorDataRecord sensorDataRecord = new SensorDataRecord(mAccele_str, mGyroscope_str, mLinearAcceleration_str,
                mRotationVector_str, mProximity_str, mLight_str, mPressure_str, mRelativeHumidity_str, mAmbientTemperature_str, String.valueOf(session_id));
